...
public class DataBase {
    ...
    public DataBase(ProfileRepository profileRepository, CardRepository cardRepository) {
...
//
//
    public void createPayment_Procedure() {
...
//        jdbcTemplate.update(sql);
    ...
    public void addCompanyCard() {
        ...
        Card card = new Card("444", LocalDate.parse("2025-08-08"), 0L, GeneralStatus.ACTIVE, "123", LocalDateTime.now());
